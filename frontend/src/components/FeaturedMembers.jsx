...
export default function FeaturedMembers() {
  return (
    <section className="py-20 px-4 sm:px-6 bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-950 dark:to-gray-900 transition-colors duration-300">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent mb-6">
            Featured Members
          </h2>
        ...
        <div className="grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {members.map((member, index) => (
            ...
            >
              ...
              <p className="text-purple-600 dark:text-purple-300 text-sm sm:text-base mb-2">
                {member.role}
              </p>
              ...
              <a
                ...
                className="inline-block px-4 py-2 bg-gradient-to-r from-purple-100 to-blue-100 dark:from-purple-800 dark:to-blue-800 text-purple-600 dark:text-purple-200 rounded-full text-sm font-medium hover:shadow-lg transition-all duration-300"
              >
                View Profile
              </a>
            </motion.div>
